...
def run_attack(speaker_class: int, idx:int, init_type: str = 'zeros'):
    ...
    #torch.save(inverted_sample_gan_norm, f"inverted_samples/{init_type}/{speaker_class}/{idx}/inverted_sample_gan-normaud.pt")
    #torch.save(inverted_sample_gan, f"inverted_samples/{init_type}/{speaker_class}/{idx}/inverted_sample_gan.pt")
    torch.save(inverted_sample_gan_std, f"inverted_samples/{init_type}/{speaker_class}/{idx}/inverted_sample_gan-std.pt")
    return True
