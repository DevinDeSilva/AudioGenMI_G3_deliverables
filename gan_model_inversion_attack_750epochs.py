...
print(os.getcwd())
# %%
load_dict = torch.load('SINCNET_SR/20251129_142613/checkpoint.pth', weights_only=False)
...
gen_weight = torch.load("models/HIFIGAN_ADV/20251205_070036/checkpoint.pth")
...
def run_attack(speaker_class: int, idx:int, init_type: str = 'zeros'):
    ...
    torch.save(inverted_sample_gan_norm, f"inverted_samples/{init_type}/{speaker_class}/{idx}/inverted_sample_gan-normaud-750epochs.pt")
    torch.save(inverted_sample_gan, f"inverted_samples/{init_type}/{speaker_class}/{idx}/inverted_sample_gan-750epochs.pt")
    return True
